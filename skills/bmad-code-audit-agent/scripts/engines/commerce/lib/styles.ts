 ...
 * ================================================
 * All ExcelJS styling objects and utility functions used by the report generator.
 */

import type { Fill, Font, Alignment, Border, Borders, Worksheet } from "exceljs";
...
export const NUM_FONT: Partial<Font> = { name: "Calibri", size: 10, color: { argb: "FF666666" } };
